...
const defaultItems = [
  { id: 1, name: 'Болт М12 оцинкованный', unit: 'шт', stock: 2000, leadTime: 3, minStock: 500, consumption: [140, 160, 150, 155, 145, 165, 170], price: 12, category: 'Крепёж' },
  { id: 2, name: 'Труба полиэтиленовая 110 мм', unit: 'м', stock: 80, leadTime: 14, minStock: 200, consumption: [50, 55, 48, 60, 52, 58, 54], price: 320, category: 'Трубы' },
  { id: 3, name: 'Краска фасадная белая 20л', unit: 'шт', stock: 25, leadTime: 5, minStock: 40, consumption: [8, 10, 12, 9, 11, 10, 13], price: 2500, category: 'ЛКМ' },
  { id: 4, name: 'Перчатки рабочие х/б', unit: 'пар', stock: 300, leadTime: 2, minStock: 500, consumption: [150, 160, 140, 170, 155, 165, 175], price: 45, category: 'СИЗ' },
  { id: 5, name: 'Светильник светодиодный 40W', unit: 'шт', stock: 60, leadTime: 10, minStock: 100, consumption: [25, 30, 28, 32, 27, 29, 31], price: 890, category: 'Освещение' },
  { id: 6, name: 'Саморез кровельный 4.8х35', unit: 'шт', stock: 5000, leadTime: 2, minStock: 2000, consumption: [600, 650, 700, 680, 720, 690, 750], price: 1.5, category: 'Крепёж' },
  { id: 7, name: 'Утеплитель минеральный 50мм', unit: 'м²', stock: 120, leadTime: 7, minStock: 300, consumption: [40, 45, 50, 48, 52, 55, 58], price: 380, category: 'Утеплители' },
  { id: 8, name: 'Фильтр масляный для двигателя', unit: 'шт', stock: 15, leadTime: 14, minStock: 30, consumption: [3, 4, 3, 5, 4, 3, 4], price: 450, category: 'Запчасти' },
]
    ...
    try {
      const response = await fetch(AI_SERVER_URL, {
        ...
        body: JSON.stringify({
          ...
          suppliers: [{ name: 'Поставщик', price: item.price, deliveryDays: item.leadTime }]
        }),
      })
  ...
  const handleFileUpload = (e) => {
    ...
    reader.onload = (ev) => {
      ...
      const newItems = rows.slice(1).map((row, idx) => ({
        ...
        price: Number(row[12]) || 0, category: row[13] || 'Без категории'
      }))
      setItems(newItems)
